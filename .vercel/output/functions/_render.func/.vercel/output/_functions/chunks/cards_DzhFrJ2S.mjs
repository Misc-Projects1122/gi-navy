const enginnerItemCards = [
  {
    imgSrc: "/assets/solutions1.webp",
    altText: "INS Jyoti",
    title: "INS Jyoti",
...
const criticalItemCards = [
  {
    index: 1,
    imgSrc: "/assets/structure1.webp",
...
export { criticalItemCards as c, enginnerItemCards as e };
