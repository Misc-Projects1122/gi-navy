...
function createGetCollection({
  ...
  return async function getCollection(collection, filter) {
    ...
    let entries = [];
    if (!Object.assign({"ASSETS_PREFIX": undefined, "BASE_URL": "/", "DEV": false, "MODE": "production", "PROD": true, "SITE": "https://astroship.web3templates.com", "SSR": true}, {})?.DEV && cacheEntriesByCollection.has(collection)) {
...
}, "/Users/veestar/veestar/gi-navy/src/pages/blog/[slug].astro", void 0);

const $$file = "/Users/veestar/veestar/gi-navy/src/pages/blog/[slug].astro";
const $$url = "/blog/[slug]";
